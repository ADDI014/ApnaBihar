  ...
  return (
    <div className="bg-stone-50">
      ...
      <header 
        ...
        style={{ backgroundImage: "url('/images/Background/arts-panorama.jpg')" }} // Add an art-related image
      >
        ...
        <div className="relative container mx-auto px-6 h-full flex flex-col justify-center items-center text-center text-white">
          ...
          <p className="text-lg md:text-xl max-w-3xl mt-4">
            Explore the rich artistic traditions of Bihar, where ancient techniques and cultural narratives are woven into every creation.
          </p>
        </div>
      </header>
